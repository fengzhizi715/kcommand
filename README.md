...
```groovy
implementation 'cn.netdiscovery.kcommand:kcommand-core:1.3.3'
```

```groovy
implementation 'cn.netdiscovery.kcommand:kcommand-rxjava2:1.3.3'
```

```groovy
implementation 'cn.netdiscovery.kcommand:kcommand-rxjava3:1.3.3'
```
